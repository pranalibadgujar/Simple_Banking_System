...
<div class="container">
        <h2 class="text-center pt-4" style="color : white;text-decoration:overline;margin-bottom:50px;margin-top:30px">Delete Users</h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="removeuserrq.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn btn-danger" style="border-radius:0%;">Delete</button></a></td> 
                    </tr>
                <?php
                        $cnt=$cnt+1;
                    }
